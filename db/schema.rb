...
ActiveRecord::Schema.define(version: 20160606154002) do
  ...
  create_table "reports", force: :cascade do |t|
    t.integer  "reportee_id"
    t.integer  "reported_event_id"
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
  end

  add_index "reports", ["reported_event_id"], name: "index_reports_on_reported_event_id"
  add_index "reports", ["reportee_id", "reported_event_id"], name: "index_reports_on_reportee_id_and_reported_event_id", unique: true
  add_index "reports", ["reportee_id"], name: "index_reports_on_reportee_id"
